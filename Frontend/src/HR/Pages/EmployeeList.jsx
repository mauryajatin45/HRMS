...
export default function EmployeeList() {
  ...
  const employees = [
    { id: 1, name: 'John Doe', email: 'john@example.com', designation: 'Frontend Developer', status: 'Active' },
    { id: 2, name: 'Jane Smith', email: 'jane@example.com', designation: 'UX Designer', status: 'Active' },
    { id: 3, name: 'Robert Johnson', email: 'robert@example.com', designation: 'Backend Developer', status: 'Inactive' },
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 sm:p-6">
      <title>All Employee | HR</title>
      {/* Header */}
      <div className="flex flex-col md:flex-row justify-between md:items-center gap-4 mb-8">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-800">Employee Directory</h1>
          <p className="text-gray-500 mt-1">{employees.length} total employees • {employees.filter(e => e.status === 'Active').length} active</p>
        </div>
              ...
              filteredEmployees.map(emp => (
                <tr key={emp.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-right">
                    <button
                      onClick={() => navigate(`/admin/employee/manage/${emp.id}`)}
